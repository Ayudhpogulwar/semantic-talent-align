    ...
    <div>
      ...
      <div className="row g-4">
        ...
        <div className="col-lg-6">
          <div className="card shadow-sm h-100 border-0">
            <div className="card-body">
              <h6 className="card-title fw-bold text-dark">Application Funnel Conversion</h6>
              ...
              <ResponsiveContainer width="100%" height={300}>
                <FunnelChart>
                  ...
                  <Funnel dataKey="value" data={funnelData} isAnimationActive>
                    <LabelList position="right" dataKey="name" fill="#334155" stroke="none" fontWeight={600} />
                  </Funnel>
                </FunnelChart>
              </ResponsiveContainer>
            </div>
        ...
        <div className="col-lg-6">
          <div className="card shadow-sm h-100 border-0">
            <div className="card-body">
              <h6 className="card-title fw-bold text-dark">Cohort-Wide Skill Gap Heatmap (Bar View)</h6>
